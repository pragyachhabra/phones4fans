...
<div class="container">
    ...
    <div class="pull-right">
                <button class="btn btn-block btn-info" data-toggle="modal" data-target="#add_new_record_modal"><i class="glyphicon glyphicon-plus"></i> Add new Keyword</button>
            </div>
            <br/>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="first_name" placeholder="Enter New Keyword" class="form-control"/>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="addtoken()">Add Record</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="update_first_name">Keyword</label>
                    <input type="text" id="update_first_name" placeholder="Enter New Keyword" class="form-control"/>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" onclick="UpdatetokenDetails()" >Save Changes</button>
